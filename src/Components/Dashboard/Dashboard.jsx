          ...
          <div className="dashboard_main_container">
            ...
            {allCountryData ? (
              ...
              <>
                ...
                <hr
                  style={{ color: "#f5f5f5", width: "90%", margin: "auto" }}
                />
                ...
                <div className="dashboard_view_statistics">
                  ...
                  <div className="view_statistics_button">
                    <Button
                      style={{
                        fontSize: "small",
                        transform: staticbuttonres ? "rotate(-90deg)" : null,
                        marginLeft: staticbuttonres ? "-100px" : 0,
                      }}
                      variant="outlined"
                    >
                      {staticbuttonres ? "statistics" : "View Statistics"}
                    </Button>
                  </div>
                </div>
                <hr
