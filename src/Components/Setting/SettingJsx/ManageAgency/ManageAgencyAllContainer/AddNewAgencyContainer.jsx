...
import '../../ManageDriver/AddDriver.css'
...
function AddNewAgencyContainer({ setshowAddAgency }) {
    ...
    return (
        <div className=" add_driver__main">
            <div className="add_driver__container">
                <div className="add_driver_cancleBtn"><ClearIcon className="add_driver_clearbtn" onClick={() => setshowAddAgency(false)} /></div>
                 
                <div className="add_driver_driverData">
                    <div className="add_driver_left_data">
                        <label htmlFor="">Agency/Company/Individual name:</label>
                    ...
                    <div className="add_driver_right_data">
                        ...
                        <div className="add_new_agency_dropdown1">
                        ...
                        <label htmlFor=""> Cylinder Selling Price :</label>
...
export default AddNewAgencyContainer
