          ...
          <div className="accessories_all_container">
            {
              ...
              getEccessArray.map((ele, idx) => (
                ...
                <div className={imgDiv}>
                    {/* <img src={ele.image} style={{width:"100%", height:"100%"}} alt="Imahe" /> */}
                    <img src="https://upload.wikimedia.org/wikipedia/commons/5/55/John_William_Waterhouse_A_Mermaid.jpg" alt="a mermaid"></img>
                </div>
