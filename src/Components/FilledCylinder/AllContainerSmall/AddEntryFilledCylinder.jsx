...
function AddEntryFilledCylinder({ setShowAddEntryFilledCylinder }) {
  ...
  const postAPI = async () => {
    ...
    FormDatas.append(
      "filled_cylinder_quantity",
      JSON.stringify([
        { cylinder_type_id: postDataFilled, quantity: increDecre },
      ])
    );
    // FormDatas.append();
    ...
    <div style={add_entry_filled_cylinder__main}>
      <div style={add_entry_filled_cylinder__container}>
        ...
        <div style={div_input_button_fc}>
          ...
          <select
            value={postDataFilled}
            onChange={(e) => setpostDataFilled(e.target.value)}
            style={{
              width: "75%",
              height: "30px",
              backgroundColor: "#fff",
          ...
          <div style={{ marginTop: "10px", display: "flex" }}>
            <button
              onClick={() =>
                setincreDecre(increDecre <= 1 ? increDecre : increDecre - 1)
              }
              style={{
                borderRadius: "5px",
                width: "27px",
            ...
            <button
              onClick={() => setincreDecre(increDecre + 1)}
              style={{
                borderRadius: "5px",
                width: "27px",
                background: "#fff",
          ...
          >
            <Button
              onClick={postAPI}
              style={{ padding: " 8px 60px", textTransform: "capitalize" }}
              variant="contained"
              color="success"
            >
              Save
